...
def qlstm(mode, batchsize, T, question_vocab_size):
    ...
    # convolution
    n.word_feature_3 = L.Convolution(n.embed_scale_resh, kernel_h=3, kernel_w=300, stride=1, num_output=2048, pad_h=1, pad_w=0, weight_filler=dict(type='xavier'))
    ...
    n.concat_vec_dropped = L.Dropout(n.word_vec_3,dropout_param={'dropout_ratio':0.5})
