...
MAX_WORDS_IN_QUESTION = 22
LENGTH_OF_LONGEST_WORD = 17
#MAX_CHARS_IN_QUESTION = 100
MAX_ITERATIONS = 1000000
PRINT_INTERVAL = 1000
VALIDATE_INTERVAL = 160000 # We train on 'train' and test on 'val'. Set it to the number of iterations for training. Then the validation accuracy is the test accuracy.
