...
PRINT_INTERVAL = 1000
VALIDATE_INTERVAL = 30000 # We train on 'train' and test on 'val'. Set it to the number of iterations for training. Then the validation accuracy is the test accuracy.
